...
.Prerequisite
All data objects required for your test scenario have been created or imported and are listed in the *Data Objects* tab of the legacy test scenarios designer.

.Procedure
. In the legacy test scenarios designer, click *EXPECT* to open the *New expectation* window with the available facts.
+
