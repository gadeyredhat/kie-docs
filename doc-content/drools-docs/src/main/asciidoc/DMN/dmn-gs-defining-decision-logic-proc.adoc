...
To calculate the fine and to decide whether the driver is to be suspended or not, you can define the traffic-violation DMN decision logic using a DMN decision table and context boxed expression.
...
.Prerequisite
* You have assigned the DMN custom data types to the appropriate decision and input nodes in the traffic-violation DRD in {CENTRAL}.
