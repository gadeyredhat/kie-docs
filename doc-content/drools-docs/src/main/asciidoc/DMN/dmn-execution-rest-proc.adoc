...
[NOTE]
====
Attribute model-namespace is automatically generated and is different for every user. Ensure that the model-namespace and model-name attributes in Step 5 to match those of the model deployed and queried in Step 4.
====
