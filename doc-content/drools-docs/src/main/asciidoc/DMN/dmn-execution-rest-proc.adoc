...
[source]
----
curl -u wbadmin:wbadmin -H "accept: application/json" -H "content-type: application/json" -X POST "http://localhost:8080/kie-server/services/rest/server/containers/Traffic-Violation_1.0.0/dmn" -d "{ \"model-namespace\" : \"https://github.com/kiegroup/drools/kie-dmn/_60B01F4D-E407-43F7-848E-258723B5FAC8\", \"model-name\" : "Traffic Violation", \"decision-name\" : [ ], \"decision-id\" : [ ], \"dmn-context\" : {"Driver" : {"Points" : 15}, "Violation" : {"Type" : "speed", "Actual Speed" : 135, "Speed Limit" : 100}}"
----
