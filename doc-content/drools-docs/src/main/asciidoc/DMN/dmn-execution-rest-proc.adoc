...
[source]
----
curl -u wbadmin:wbadmin -H "accept: application/xml" -X GET "http://localhost:8080/kie-server/services/rest/server/containers/Traffic-Violation_1.0.0"
----
...
----
<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<response type="SUCCESS" msg="Info for container Traffic-Violation_1.0.0">
    <kie-container container-alias="Traffic-Violation" container-id="Traffic-Violation_1.0.0" status="STARTED">
        <config-items>
        ...
        <messages>
            <content>Container Traffic-Violation_1.0.0 successfully created with module org.kie.example.traffic:Traffic-Violation:1.0.0.</content>
            <severity>INFO</severity>
            <timestamp>2019-02-20T14:24:23.615+05:30</timestamp>
        </messages>
        <release-id>
            <artifact-id>Traffic-Violation</artifact-id>
            <group-id>org.kie.example.traffic</group-id>
...
{
  "type" : "SUCCESS",
  "msg" : "Info for container Traffic-Violation_1.0.0",
  "result" : {
    "kie-container" : {
      "container-id" : "Traffic-Violation_1.0.0",
      "release-id" : {
      ...
      "messages" : [ {
        "severity" : "INFO",
        "timestamp" : {
  "java.util.Date" : 1550652863615
},
        "content" : [ "Container Traffic-Violation_1.0.0 successfully created with module org.kie.example.traffic:Traffic-Violation:1.0.0." ]
      } ],
      "container-alias" : "Traffic-Violation"
    }
  }
}
----
