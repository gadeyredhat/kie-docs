...
= Testing the traffic violations test scenarios

You will use the Test Scenarios editor in {CENTRAL} to test the DMN decision requirements diagrams (DRDs) and define decision logic for the traffic violation project.
...
.. Click *+Ok* to open the *Violation Scenarios* test scenario in the *Test Scenarios* editor.
. From the *Given* column header,
