...
include::{enterprise-dir}/project-data/test-designer-expressions-syntax-intro-ref.adoc[leveloffset=+3]
include::{enterprise-dir}/project-data/test-designer-expressions-syntax-rule-based-ref.adoc[leveloffset=+4]
include::{enterprise-dir}/project-data/test-designer-expressions-syntax-dmn-based-ref.adoc[leveloffset=+4]
include::{enterprise-dir}/project-data/test-scenarios-designer-run-test-proc.adoc[leveloffset=+2]
include::{enterprise-dir}/project-data/test-scenarios-designer-create-mortgages-example-proc.adoc[leveloffset=+2]

include::{drools-dir}/AuthoringAssets/test-scenarios-running-locally-proc.adoc[leveloffset=+1]

// Test Scenarios (Legacy) editor files
include::{drools-dir}/AuthoringAssets/test-scenario-editor-con.adoc[leveloffset=+1]
